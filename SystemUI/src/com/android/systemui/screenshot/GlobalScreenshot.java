...
class SaveImageInBackgroundTask extends AsyncTask<SaveImageInBackgroundData, Void,
   ...
   // private final BigPictureStyle mNotificationStyle;
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
        ...
        croppedIcon = Bitmap.createScaledBitmap(preview, iconSize, iconSize, true);
        extras.putParcelable("override-left", GlobalScreenshot.getBitmap(r,R.drawable.screenshot_notify));
...
//                             PendingIntent.FLAG_CANCEL_CURRENT));
    ...
    protected void onPostExecute(SaveImageInBackgroundData params) {
        ...
        if (params.result > 0) {
            ...
            extras.putParcelable("override-left", croppedIcon);
...
class GlobalScreenshot {
    ...
    public static final String DIRECTORY = PICTURES + "/ScreenShots";
    ...
    void takeScreenshot(Runnable finisher, boolean statusBarVisible, boolean navBarVisible) {
        ...
        if (mScreenBitmap == null || getInternalStorageAvailableSpace() < LOW_STORAGE_THRESHOLD_BYTES) {
    ...
    static void notifyScreenshotError(Context context, NotificationManager nManager) {
        Resources r = context.getResources();
        Bundle extras = new Bundle();
        extras.putParcelable("override-left",
                getBitmap(r,R.drawable.screenshot_notify_error));
    ...
    static Bitmap getBitmap(Resources res,int iconId) {
