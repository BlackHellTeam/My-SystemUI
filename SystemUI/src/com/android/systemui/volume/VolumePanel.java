...
import com.lewa.systemuiext.utils.ZenModeHelper;
/**
...
public class VolumePanel extends Handler {
    ...
    private static final int TIMEOUT_DELAY = 2500;
    private static final int TIMEOUT_DELAY_SHORT = 1500;
    private static final int TIMEOUT_DELAY_COLLAPSED = 2500;
    private static final int TIMEOUT_DELAY_SAFETY_WARNING = 5000;
    private static final int TIMEOUT_DELAY_EXPANDED = 2500;
    ...
    private static final int IC_AUDIO_VOL = com.lewa.systemuiext.R.drawable.ic_audio_vol_normal;
    private static final int IC_AUDIO_VOL_MUTE = com.lewa.systemuiext.R.drawable.ic_audio_vol_normal;
    ...
    private VolumeImageView mCircieView;
    ...
    private enum StreamResources {
        ...
        RingerStream(AudioManager.STREAM_RING,
                com.lewa.systemuiext.R.string.volume_icon_description_ringer,
                com.lewa.systemuiext.R.drawable.ic_ringer_audible_normal,
                com.lewa.systemuiext.R.drawable.ic_slient_vibrate_normal,
                com.lewa.systemuiext.R.drawable.ic_ringer_big_audible,
                false),
        VoiceStream(AudioManager.STREAM_VOICE_CALL,
                R.string.volume_icon_description_incall,
                R.drawable.ic_audio_phone,
                R.drawable.ic_audio_phone,
                com.lewa.systemuiext.R.drawable.ic_audio_big_phone,
                false),
        AlarmStream(AudioManager.STREAM_ALARM,
                com.lewa.systemuiext.R.string.volume_icon_description_alarm,
                com.lewa.systemuiext.R.drawable.ic_audio_alarm_normal,
                com.lewa.systemuiext.R.drawable.ic_audio_alarm_normal,
                com.lewa.systemuiext.R.drawable.ic_audio_big_alarm,
                false),
        MediaStream(AudioManager.STREAM_MUSIC,
                com.lewa.systemuiext.R.string.volume_icon_description_media,
                IC_AUDIO_VOL,
                IC_AUDIO_VOL_MUTE,
                com.lewa.systemuiext.R.drawable.ic_audio_big_vol,
                true),
        NotificationStream(AudioManager.STREAM_NOTIFICATION,
                R.string.volume_icon_description_notification,
                com.lewa.systemuiext.R.drawable.ic_ringer_audible_normal,
                com.lewa.systemuiext.R.drawable.ic_ringer_vibrate_normal,
                com.lewa.systemuiext.R.drawable.ic_ringer_big_audible,
                true),
        ...
        StreamResources(int streamType, int descRes, int iconRes, int iconMuteRes, int iconBigRes,boolean show) {
            this.streamType = streamType;
            this.descRes = descRes;
            this.iconRes = iconRes;
            this.iconMuteRes = iconMuteRes;
            this.show = show;
            this.iconBigRes = iconBigRes;
        }
    }
    ...
    public VolumePanel(Context context, ViewGroup parent, ZenModeController zenController) {
        ...
        mZenModeHelper = new ZenModeHelper(context,new Handler());
    ...
    private void createSliders() {
        ...
        for (int i = 0; i < STREAMS.length; i++) {
            ...
            sc.circle = (ViewGroup) inflater.inflate(
                    com.android.systemui.R.layout.volume_panel_circle, null);
            sc.group = (ViewGroup) inflater.inflate(
                    com.android.systemui.R.layout.volume_panel_item, null);
            sc.zenView = (ViewGroup) inflater.inflate(
                    com.android.systemui.R.layout.volume_panel_zen, null);
            sc.group.setTag(sc);
            sc.circle.setTag(sc);
            sc.zenView.setTag(sc);

            mZenPanel = (ZenModePanel) sc.zenView.findViewById(com.android.systemui.R.id.zen_mode_panel);
            initZenModePanel();
            sc.icon = (ImageView) sc.group.findViewById(com.android.systemui.R.id.stream_icon);
            sc.icon.setTag(sc);
            sc.icon.setContentDescription(res.getString(streamRes.descRes));

            sc.circleIcon = (ImageView) sc.circle.findViewById(com.android.systemui.R.id.centerImage);
            sc.circleIcon.setTag(sc);
            sc.circleIcon.setContentDescription(res.getString(streamRes.descRes));
            sc.circleView = (VolumeImageView) sc.circle.findViewById(com.android.systemui.R.id.circleButton);

            sc.zenIcon = (ImageView) sc.zenView.findViewById(com.android.systemui.R.id.zen_stream_icon);
            sc.zenIcon.setTag(sc);
            sc.zenIcon.setContentDescription(res.getString(streamRes.descRes));

            sc.iconRes = streamRes.iconRes;
            sc.iconBigRes = streamRes.iconBigRes;
            sc.iconMuteRes = streamRes.iconMuteRes;
            sc.icon.setImageResource(sc.iconRes);

            sc.circleIcon.setImageResource(sc.iconBigRes);
            final View.OnClickListener showOtherView = new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Log.d(TAG,"showSeekbarOnTouch....");
                        addOtherVolumes();
                }
            };
            final View.OnLongClickListener showZenView = new View.OnLongClickListener() {
                @Override
            ...
            sc.circleView.setOnClickListener(showOtherView);
            if (isNotificationOrRing(streamType)) {
                sc.circleView.setOnLongClickListener(showZenView);
            }

            sc.zenIcon.setClickable(isNotificationOrRing(streamType));
            if (sc.zenIcon.isClickable()) {
                sc.zenIcon.setSoundEffectsEnabled(false);
                sc.zenIcon.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
            ...
            sc.volumeTitle =
                    (TextView) sc.group.findViewById(com.android.systemui.R.id.volume_title);
            sc.volumeTitle.setText(res.getString(streamRes.descRes));

            sc.zenTitle =
                    (TextView) sc.zenView.findViewById(com.android.systemui.R.id.zen_volume_title);
            sc.zenTitle.setText(res.getString(streamRes.descRes));

            sc.seekbarView = (SeekBar) sc.group.findViewById(com.android.systemui.R.id.seekbar);

            sc.zenSeekbar = (SeekBar) sc.zenView.findViewById(com.android.systemui.R.id.zen_seekbar);
            ...
            sc.zenSeekbar.setMax(getStreamMaxVolume(streamType) + plusOne);
            sc.zenSeekbar.setProgress(0);
            sc.seekbarView.setOnSeekBarChangeListener(mSeekListener);
            sc.seekbarView.setTag(sc);

            sc.zenSeekbar.setEnabled(false);//setOnSeekBarChangeListener(mZenSeekListener);
            sc.zenSeekbar.setTag(sc);
    ...
    private void reorderSliders(int activeStreamType) {
        ...
        boolean isRinger = isNotificationOrRing(active.streamType);
        if (active == null) {
            Log.e(TAG, "Missing stream type! - " + activeStreamType);
            mActiveStreamType = -1;
        } else if (getZenMode() == Global.ZEN_MODE_NO_INTERRUPTIONS && isRinger) {
            mActiveStreamType = activeStreamType;
            mSliderPanel.setBackgroundResource(com.android.systemui.R.drawable.qs_background_secondary);
            mSliderPanel.addView(active.zenView);
            active.zenView.setVisibility(View.VISIBLE);
            updateSlider(active);
            updateTimeoutDelay();
        } else {
            mActiveStreamType = activeStreamType;
            mSliderPanel.setBackgroundDrawable(null);
            mSliderPanel.addView(active.circle);
            active.circle.setVisibility(View.VISIBLE);
            updateSlider(active);
            updateTimeoutDelay();
        }
    }
    private void updateSliderProgress(StreamControl sc, int progress) {
        ...
        int maxProgress = getStreamMaxVolume(sc.streamType);
        float percentage = progress * 1.0f / maxProgress;
        sc.circleView.setPercentage(percentage);
    ...
    private void updateSliderIcon(StreamControl sc, boolean muted) {
        ...
        sc.circleIcon.setImageResource(muted ? com.lewa.systemuiext.R.drawable.ic_slient_vibrate_big : sc.iconBigRes);
        if (muted) {
            sc.circleView.removeCircleView();
        }
    }
    ...
    private void updateSliderSupressor(StreamControl sc) {
        ...
        if (suppressor == null) {
            ...
            sc.circleIcon.setImageResource(sc.iconSuppressedRes);
        }
    }
    ...
    private void addOtherVolumes() {
        ...
        for (int i = 0; i < STREAMS.length; i++) {
            ...
            if (streamType == AudioManager.STREAM_RING) {
                sc.volumeTitle.setText(com.android.systemui.R.string.volume_icon_description_ringer);
                mSliderPanel.addView(sc.group);
            } else if (streamType == AudioManager.STREAM_MUSIC) {
                sc.volumeTitle.setText(com.android.systemui.R.string.volume_icon_description_media);
                mSliderPanel.addView(sc.group);
            } else if (streamType == AudioManager.STREAM_ALARM) {
                sc.volumeTitle.setText(com.android.systemui.R.string.volume_icon_description_alarm);
                mSliderPanel.addView(sc.group);
            }
            updateSlider(sc);
        }
    ...
    private void addZenVolumes () {
            mSliderPanel.removeAllViews();
            final StreamControl active = mStreamControls.get(mActiveStreamType);
            if (active == null)return;
            mSliderPanel.setBackgroundResource(com.android.systemui.R.drawable.qs_background_secondary);
            mSliderPanel.addView(active.zenView);
            active.zenSeekbar.setProgress(0);
            active.zenTitle.setText(com.android.systemui.R.string.volume_icon_description_ringer);
            active.zenView.setVisibility(View.VISIBLE);
            if (!isZenPanelVisible()) {
                mZenPanel.setVisibility(View.VISIBLE);
            }
            setZenMode(Global.ZEN_MODE_NO_INTERRUPTIONS);
            resetTimeout();
            forceTimeout(TIMEOUT_DELAY);
    }
    ...
    private void updateSlider(StreamControl sc) {
        ...
        sc.circleIcon.setImageDrawable(null);
    ...
    private void setZenMode(int value) {
        if (mZenPanel != null) {
            mZenPanel.setZen(value);
        }
    }

    private int getZenMode() {
        if (mZenPanel != null) {
            return mZenPanel.getZen();
        }
        return -1;
    }
...
//                setRingerIcon();
        ...
        if (sc != null) {
            ...
            if (LOGD) { Log.d(mTag, "updateSlider->index: "+index); }
        ...
        if (!isShowing()) {
            ...
            boolean isRinger = isNotificationOrRing(streamType);
            if (isRinger && getZenMode() == Global.ZEN_MODE_NO_INTERRUPTIONS) {
                setZenMode(Global.ZEN_MODE_OFF);
                reorderSliders(streamType);
            }
        }
        ...
        } else if(index == 0 && mAudioManager.getRingerMode() == AudioManager.RINGER_MODE_VIBRATE){
            sendMessageDelayed(obtainMessage(MSG_VIBRATE), VIBRATE_DELAY);
        }
    ...
    private final OnSeekBarChangeListener mZenSeekListener = new OnSeekBarChangeListener() {
        @Override
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
    ...
    private final VolumeImageView.CallBack mCircleCallBack = new VolumeImageView.CallBack() {

        @Override
        public void animationEnd(int endEngle) {
        }

        @Override
        public void animationStart(int endEngle) {
        }
    };
