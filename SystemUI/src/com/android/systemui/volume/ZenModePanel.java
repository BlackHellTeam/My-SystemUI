...
public class ZenModePanel extends LinearLayout {
    ...
    private static final int[] MINUTE_BUCKETS = DEBUG
            ? new int[] {0,1,2,10,15, 30, 45, 60, 120, 180, 240, 480 }
    ...
    private void updateWidgets() {
        ...
        mZenConditions.setVisibility(VISIBLE );
    ...
    private void bind(final Condition condition, View convertView) {
        ...
        if (condition == null) {
            ...
            if (sameConditionId(mSessionExitCondition, tag.condition)) {
                tag.title.setText(mContext.getString(com.android.systemui.R.string.volume_time_final)+condition.summary);
            } else {
