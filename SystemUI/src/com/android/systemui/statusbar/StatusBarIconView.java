...
public class StatusBarIconView extends AnimatedImageView {
    ...
    private final int mWidth = 54;
    private final int mHeight = 42;
    ...
    public StatusBarIconView(Context context, String slot, Notification notification) {
        ...
        if (notification != null) {
            ...
            String spStr[] = slot.split("/"); 
            if (PhoneStatusBar.getAppPackageName() != null
                    && !PhoneStatusBar.getAppPackageName().contains(spStr[0])) {
                setScaleX(scale);
                setScaleY(scale);
            }
        }
    ...
    public static Drawable getIcon(Context context, StatusBarIcon icon) {
        ...
        if (icon.iconPackage != null) {
            try {
                ...
                ///lewa add
                if (!(icon.iconPackage.equals("android") || 
                     icon.iconPackage.equals("com.android.systemui")||
                     isHeadsetIcon(icon.iconId))) {
                    ApplicationInfo info = context.getPackageManager().getApplicationInfo(icon.iconPackage, 0);
                    drawable = ThemeManager.getInstance(context).loadIcon(info);
                    return drawable;
                }
                ////lewa end
    ...
    private static boolean isHeadsetIcon(int iconId){  
    return iconId == com.android.internal.R.drawable.stat_sys_headset;
    }
    @Override
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawColor(R.color.volume_background);*/
        super.onDraw(canvas);
        if (mNumberBackground != null) {
