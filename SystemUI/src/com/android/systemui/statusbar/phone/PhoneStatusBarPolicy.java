...
public class PhoneStatusBarPolicy {
    ...
    private static final String SLOT_POWER_LIGHT = "power_light";
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if (action.equals(ACTION_STATUS_POWER_LIGHT)) {
                updatePowerLight(intent);
            }
        }
    };
    ...
    public PhoneStatusBarPolicy(Context context, CastController cast) {
        ...
        filter.addAction(ACTION_STATUS_POWER_LIGHT);
        ...
        //power light
        mService.setIcon(SLOT_POWER_LIGHT, com.lewa.systemuiext.R.drawable.stat_sys_highlight, 0, null);
        mService.setIconVisibility(SLOT_POWER_LIGHT, false);
    ...
    private final void updateVolumeZen() {
        ...
        if (mZen == Global.ZEN_MODE_NO_INTERRUPTIONS) {
            zenVisible = true;
            zenIconId = R.drawable.stat_sys_ringer_silent;
            ...
            volumeVisible = true;
            volumeIconId = R.drawable.stat_sys_vibrate_silent;
    ...
    private final void updatePowerLight(Intent intent) {
        int iconId = 0;
        int currentMode = intent.getIntExtra("state",0);
        boolean showIcon = (currentMode == 1 ) ? true : false;
        if (showIcon) {
            iconId = com.lewa.systemuiext.R.drawable.stat_sys_highlight;
            mService.setIcon(SLOT_POWER_LIGHT, iconId, 0, "power_light");
            mService.setIconVisibility(SLOT_POWER_LIGHT, true);
        } else {
            mService.setIconVisibility(SLOT_POWER_LIGHT, false);
        }
    }
