...
public abstract class Ticker {
    ...
    private HashSet mLewaAppPackageName;
    ...
    public Ticker(Context context, View sb,HashSet lewaAppPackageName) {
        mContext = context;
        mLewaAppPackageName = lewaAppPackageName;
    ...
    public void addEntry(StatusBarNotification n) {
        ...
        /*android.util.Log.i("luo%%%", "n.getPackageName() :"
                + n.getPackageName());
        android.util.Log.i("luo%%%", "is inner package name:"
                + !mLewaAppPackageName.contains(n.getPackageName()));
        if (mLewaAppPackageName != null) {
            if (mLewaAppPackageName.contains(n.getPackageName())) {
                mIconSwitcher.setScaleX(1);
                mIconSwitcher.setScaleY(1);
            } else {
