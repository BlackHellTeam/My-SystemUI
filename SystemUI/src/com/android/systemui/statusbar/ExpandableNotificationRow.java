...
public class ExpandableNotificationRow extends ActivatableNotificationView {
    ...
    private View mNotificationBlockView;
    private TextView mNotificationBlockText;
    ...
    protected void onFinishInflate() {
        ...
        mNotificationBlockView = findViewById(R.id.notification_filter_view);
        mNotificationBlockText = (TextView) findViewById(R.id.notification_filter_text);
    ...
    public void setHeightRange(int rowMinHeight, int rowMaxHeight,int rowMidHeight) {
        mRowMinHeight = rowMinHeight;
        mRowMaxHeight = rowMaxHeight;
        mRowMidHeight = rowMidHeight;
    }
    ...
    public void sanitizeBigLayoutParams(RemoteViews bigView, String packageName) {
        LayoutParams lp = (LayoutParams) mNotificationView.getLayoutParams();
        lp.height = (bigView != null)
                && !isEmail(packageName) ? mRowMidHeight
                : mRowMinHeight;
        mNotificationView.setLayoutParams(lp);
    }

    private boolean isEmail(String packageName) {
        return packageName.equals("com.android.email")
                || packageName.equals("com.tct.email");
    }
    @Override
