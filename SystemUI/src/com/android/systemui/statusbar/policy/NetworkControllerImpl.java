...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    int mMsimDataState = TelephonyManager.NETWORK_TYPE_UNKNOWN;
    ...
    ArrayList<TextView> mMobileLabel2Views = new ArrayList<TextView>();
    ...
    //lewa begin
    public void addMobileLabel2View(TextView v) {
        mMobileLabel2Views.add(v);
    }
    //lewa end
    ...
    protected void updateAirplaneMode() {
        ...
        Slog.d("luo", "mAirplaneMode :"+mAirplaneMode);
    }
     ...
     *         (both inclusive).
     */
    protected  int calculateSignalLevel(int rssi, int numLevels) {
        if (rssi <= MIN_RSSI) {
            return 0;
        } else if (rssi >= MAX_RSSI) {
            return numLevels - 1;
        } else {
            //lewa enhance the wifi rssi by 5
            rssi += 5;
            if (rssi >= MAX_RSSI) {
                return numLevels - 1;
            }
    ...
    protected void updateWifiState(Intent intent) {
        ...
        if (action.equals(WifiManager.WIFI_STATE_CHANGED_ACTION)) {
            ...
            //Lewa modfiy to import the wifi Level
            mWifiLevel = calculateSignalLevel(
