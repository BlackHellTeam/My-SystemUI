...
class TelephonyIcons {
    ...
    static final int[][] QS_TELEPHONY_SIGNAL_STRENGTH = {
        { R.drawable.lewa_stat_sys_signal_0,
          R.drawable.lewa_stat_sys_signal_1,
          R.drawable.lewa_stat_sys_signal_2,
          R.drawable.lewa_stat_sys_signal_3,
          R.drawable.lewa_stat_sys_signal_4,
          R.drawable.lewa_stat_sys_signal_5},
        { R.drawable.lewa_stat_sys_signal_0,
          R.drawable.lewa_stat_sys_signal_1,
          R.drawable.lewa_stat_sys_signal_2,
          R.drawable.lewa_stat_sys_signal_3,
