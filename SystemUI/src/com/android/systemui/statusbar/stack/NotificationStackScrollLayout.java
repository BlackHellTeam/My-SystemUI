...
//                }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.i("luo","mExpandingNotification --"+mExpandingNotification+"mSwipingInProgress :"+mSwipingInProgress);
...
//        addView(mEmptyShadeView);
  ...
  ///LEWA BEGIN
    ...
    private void updateEmptyView() {
        if (mEmptyView == null) {
            mEmptyView = getRootView().findViewById(R.id.emptyView);
        }
        if(mEmptyView != null) {
            mEmptyView.setVisibility(getChildCount() > 0
