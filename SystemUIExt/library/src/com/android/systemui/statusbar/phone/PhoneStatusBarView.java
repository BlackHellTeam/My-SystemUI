...
//    }
    ...
    public void addPanel(PanelView pv) {
        super.addPanel(pv);
        if (pv.getId() == com.lewa.systemuiext.R.id.notification_panel) {
            mNotificationPanel = pv;
        } 
//        else if (pv.getId() == com.lewa.systemuiext.R.id.settings_panel){
//            mSettingsPanel = pv;
//        }
        pv.setRubberbandingEnabled(!mFullWidthNotifications);
    }
...
//        if (mPanels.size() == 1) {
//            if (panel.getExpandedHeight() < panel.getPeekHeight()) {
