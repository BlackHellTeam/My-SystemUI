...
import com.lewa.systemuiext.utils.NotificationSwipeHelper;
...
public class NotificationRowLayout
        ...
        implements NotificationSwipeHelper.Callback, ExpandHelper.Callback
{
    ...
    public NotificationRowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSwipeHelper = new NotificationSwipeHelper(NotificationSwipeHelper.X, this, densityScale, pagingTouchSlop);
    }
    ...
    public View getChildAtPosition(float touchX, float touchY) {
        ...
        for (; childIdx < count; childIdx++) {
            ...
            if (touchY < y) return slidingChild.findViewById(R.id.notificationView);
        }
        return null;
    }
    ...
    public void onFinishInflate() {
        ...
        ExpandableNotificationRow row = (ExpandableNotificationRow) inflater.inflate(
                R.layout.fake_status_bar_notification_row, this, false);
        addView(row);
        //JDSONG debug
    }
